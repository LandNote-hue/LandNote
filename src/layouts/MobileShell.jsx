...
const TAB_ITEMS = [
  ...
  { id: 'calendar', label: '일정', path: MENU_PATHS.calendar },
];
...
const TabIcon = ({ id, active }) => {
  ...
  const icons = {
    ...
    calendar: (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>),
  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        /* 하단 nav에 가리지 않도록 여백 — 스크롤 영역은 자식(MobilePage 등) */
      ...
      {moreOpen && (
        <>
          ...
          <div style={{
            ...
            maxHeight: 'min(70dvh, 420px)', overflowY: 'auto', WebkitOverflowScrolling: 'touch',
